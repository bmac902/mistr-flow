...
test("overlay html contains Mistr Flow card, mascot, state hooks, and reduced motion rules", () => {
  ...
  assert.match(html, /\.top-hat[\s\S]*z-index:\s*3/);
